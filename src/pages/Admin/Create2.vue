...
<template>
    <MainHeader title="Add User"></MainHeader>
    ...
    <form @submit.prevent="studentsStore.addStudent($event, fee_type_id)"
        ...
        <div class="col-span-full font-medium text-light-gray -mb-2">User details</div>
        ...
        <div v-for="(item, index) in getPreviousSchool" :key="index" class="contents">
            <InputField label="Degree" v-model="item.class" :options="classListOption" />
